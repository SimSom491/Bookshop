...
public class AntikvarKonyv extends Konyv{
    ...
    public AntikvarKonyv(int id, String szerzo, String cim, int ar, int oldalszam, String kiado, String eleresiUt, int kiadasiEv, String tipus, int kor, String allapot) {
