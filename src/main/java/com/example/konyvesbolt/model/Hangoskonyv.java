...
public class Hangoskonyv extends Konyv{
    ...
    public Hangoskonyv(int id, String szerzo, String cim, int ar, int oldalszam, String kiado, String eleresiUt, int kiadasiEv, String tipus, String elbeszelo, int hossz) {
